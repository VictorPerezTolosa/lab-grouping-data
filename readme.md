...
You can find this LAB done in my Tableau Public profile under the name of [Lab | Grouping Data](https://public.tableau.com/views/LabGroupingData_16718198878260/5_Avgbalanceperagegroup?:language=es-ES&publish=yes&:display_count=n&:origin=viz_share_link).
